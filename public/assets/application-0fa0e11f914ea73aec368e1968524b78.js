      ...
      return jQuery(document).on('page:before-change', function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          _results.push((function() {
            var _ref1, _results1;
            _ref1 = jQuery._data(element, 'events') || {};
            _results1 = [];
            for (event in _ref1) {
              ...
              _results1.push((function() {
                ...
                for (_j = 0, _len1 = handlers.length; _j < _len1; _j++) {
                  ...
                  if ((handler != null) && handler.namespace === '') {
                    _results2.push(jQuery(element).off(event, handler.handler));
                  } else {
...
(function() {
  ...
  App.Static = (function(_super) {
    ...
    Static.prototype.home = function() {
      return $(function() {
        ...
        return $('.tabs').click(function() {
          ...
          $('#' + $tabSelector).show();
          return console.log('#' + $tabSelector);
        });
      });
    };
